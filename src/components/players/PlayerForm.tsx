...
const PlayerForm = () => {
    ...
    return (
      <div className="flex justify-center">
        <Button
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white text-lg md:text-xl px-6 py-3 md:px-8 md:py-4 h-auto rounded-xl flex items-center gap-2 shadow-lg hover:shadow-xl transition-all"
        >
  ...
  return (
    <div className="bg-blue-50/50 rounded-2xl p-4 md:p-6 mb-8 border-2 border-dashed border-blue-200 relative animate-in fade-in zoom-in duration-300">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-xl md:text-2xl font-bold text-blue-900 border-l-4 border-blue-600 pl-3">
          ተወዳዳሪ መመዝገቢያ
        </h3>
        <Button
          variant="ghost"
